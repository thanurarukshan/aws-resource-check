...
## Features
âœ… Lists all **running EC2 instances**  
âœ… Lists all **S3 buckets**  
âœ… Finds **all active RDS databases**  
âœ… Checks **all Lambda functions**  
âœ… Shows **all ECS clusters**  
âœ… Lists **Elastic Load Balancers (ALB/NLB/CLB)**  
âœ… Displays **all IAM users**  
âœ… Retrieves **Route 53 hosted zones**  
âœ… Checks **active CloudFormation stacks**  
âœ… Uses **AWS Resource Group Tagging API** to list **ALL active AWS resources**  
